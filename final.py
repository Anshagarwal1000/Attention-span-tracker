...
# pip install opencv-python dlib matplotlib scipy
...
EAR_THRESHOLD = 0.25  # Threshold for drowsy detection
...
def main():
    ...
    while True:
        ...
        for face in faces:
            ...
            # Check EAR to determine focus
            if avg_ear > EAR_THRESHOLD:  # Eyes open
                is_focused = True
    ...
    # Final calculation if still focused when exiting
    if focused and focus_start_time is not None:
        total_focus_time += time.time() - focus_start_time
